...
CREATE TABLE IF NOT EXISTS NEWS_ARTICLE (
	...
	,	PRIMARY KEY				(ARTICLE_DATE, ARTICLE_TITLE)
)
...
CREATE TABLE IF NOT EXISTS ARTICLE_LINKER (
		PUBLICATION_DATE		DATETIME
	,	ARTICLE_DATE			DATETIME
	,	ARTICLE_DEADLINE		VARCHAR(100)
	,	ARTICLE_TYPE_ID			INT(11)
	,	PRIMARY KEY				(PUBLICATION_DATE, ARTICLE_DATE, ARTICLE_TITLE)
	,	FOREIGN KEY				PUBLICATION_DATE REFERENCES 
)
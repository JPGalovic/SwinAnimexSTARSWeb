INSERT INTO EVENT_DATA (EVENT_TIME, EVENT_TYPE_ID, EVENT_TITLE, EVENT_LOCATION, EVENT_FACEBOOK_ID, EVENT_UNIONE_URL) VALUES
	...
	,	("2018-01-02 11-30-00", 0, "Summer Sessions", 0, 0, "0")
	,	("2018-01-09 11-30-00", 0, "Summer Sessions", 0, 0, "0")
...
INSERT INTO EVENT_ANIME_DATA (EVENT_TIME, ANIME_TITLE, SESSION_TYPE_ID, SESSION_NUMBER) VALUES
	...
	,	("2018-01-26 16-30-00", "Anime_Title", 0, 1)
	,	("2018-02-02 16-30-00", "Anime_Title", 0, 2)
	,	("2018-02-09 16-30-00", "Anime_Title", 0, 3)
	
	,	("2018-01-26 19-30-00", "Queen's Blade 2: The Evil Eye", 0, 1)
	,	("2018-02-02 19-30-00", "Queen's Blade 2: The Evil Eye", 0, 2)
	,	("2018-02-09 19-30-00", "Queen's Blade 2: The Evil Eye", 0, 3)
;
<?php
	...
	if(isset($event_time))
	{
		$get_game_event_query = 'SELECT EVENT_GAME_DATA.GAME_TITLE, GAME_EVENT_TYPE.DESCRIPTION FROM EVENT_GAME_DATA LEFT JOIN GAME_EVENT_TYPE ON EVENT_GAME_DATA.GAME_EVENT_TYPE = GAME_EVENT_TYPE.TYPE_ID WHERE EVENT_GAME_DATA.EVENT_TIME = "'.$event_time.'"';
